...
import static no.nav.foreldrepenger.selvbetjening.kontrakt.innsending.util.maler.UtenlandsoppholdMaler.oppholdBareINorge;
...
class ForeldrepengesoknadMappingKonsistensTest {
    ...
    void foreldrepengerVedleggReferanseMappingKonsistensTest() {
        ...
        var vedlegg2 = DokumentasjonUtil.vedlegg(DokumentasjonUtil.uttaksperioder(List.of(new ÅpenPeriodeDto(NOW, NOW.plusWeeks(1).minusDays(1)),
        ...
        var vedlegg4 = DokumentasjonUtil.vedlegg(DokumentasjonUtil.opptjening(new ÅpenPeriodeDto(utenlandskOpptjening.fom(),
            utenlandskOpptjening.tom())));
        var vedlegg5 = DokumentasjonUtil.vedlegg(DokumentasjonUtil.opptjening(new ÅpenPeriodeDto(annenNorskOpptjening.fom(),
