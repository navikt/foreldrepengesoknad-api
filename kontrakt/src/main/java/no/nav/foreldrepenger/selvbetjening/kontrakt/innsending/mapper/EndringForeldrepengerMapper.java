...
final class EndringForeldrepengerMapper {
    ...
    static Endringssøknad tilEndringForeldrepengesøknadUtenVedleggInnhold(EndringssøknadForeldrepengerDtoOLD endringssøknadFP,
    ...
    private static Foreldrepenger tilYtelse(EndringssøknadForeldrepengerDtoOLD f, List<VedleggDto> vedlegg) {
    ...
    private static Fordeling tilFordeling(EndringssøknadForeldrepengerDtoOLD f, List<VedleggDto> vedlegg) {
