...
public record UtenlandsoppholdDto(@Size(max = 20) List<@Valid @NotNull Periode> utenlandsoppholdSiste12Mnd,
                                  @Size(max = 20) List<@Valid @NotNull Periode> utenlandsoppholdNeste12Mnd) {
    ...
    public record Periode(@NotNull LocalDate fom, @NotNull LocalDate tom, CountryCode landkode) {
